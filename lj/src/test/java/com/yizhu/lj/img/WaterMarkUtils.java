...
//			Integer MOVE = number.divide(olDnumber).intValue()*150;
            // 循环添加水印
//            while (x < srcImgWidth * 3.5) {
//                y = -srcImgHeight / 2;
//                while (y < srcImgHeight * 3.5) {
...
//            }
    ...
    public static void main(String[] args) {
        ...
        String srcImgPath = "G:\\水印\\10.png"; // 源图片地址
        String tarImgPath = "G:\\水印\\16.png"; // 待存储的地址
        String waterMarkContent = "版权所有"; // 水印内容
//		Color color = Color.GRAY; // 水印图片色彩以及透明度
        Color color = new Color(255, 180, 180);
        new WaterMarkUtils().addWaterMark(srcImgPath, tarImgPath,
                waterMarkContent, color, font, 0);
    }
