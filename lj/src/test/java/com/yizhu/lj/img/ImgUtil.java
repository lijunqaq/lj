...
//            Color color = new Color(255, 195, 195);
            replaceImageColor(srcFile, dstFile, Color.WHITE);
        } catch (IOException e) {
            e.printStackTrace();
        }
    }

    public static void replaceImageColor(String file, String dstFile, Color targetColor) throws IOException {
        URL http;
        ...
        Color wColor = new Color(255, 255, 255);//浅灰色
