package com.example.lj.datasourceconfiguration;
 ...
 */
@Configuration
@MapperScan(basePackages = "com.example.lj.dao.mapper.UserMapper", sqlSessionTemplateRef = "userdbSqlSessionTemplate")
